...
<div class="container-fluid">
	...
	<nav class="navbar navbar-custom col-xs-8 col-xs-offset-2 ">
			<ul class="nav navbar-nav">
				...
				<li><a href="generate_rebate.jsp">Generate Rebate</a></li>
				<li><a href="delete_rebate.jsp">Cancel Rebate</a></li>
...
<div class="col-sm-8 col-sm-offset-2" id="couponmsg">
		<h2>Welcome to Frys Rebate Data Automation Application</h2>
</div>
